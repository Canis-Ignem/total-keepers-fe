...
export default function CatalogFilter({ tags, sizes, minPrice, maxPrice, onChange }: CatalogFilterProps) {
  ...
  return (
    <aside className="w-full max-w-xs p-6 bg-white rounded-2xl shadow-lg border border-gray-100 flex flex-col gap-8 sticky top-8 h-fit">
      <div>
        <h3 className="font-bold text-lg mb-2 text-gray-900">{t('price')}</h3>
        <div className="flex items-center gap-2">
          <input
            ...
            className="w-24 border-2 border-gray-300 bg-white rounded px-3 py-2 text-base font-semibold text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          />
      ...
      <div>
        <h3 className="font-bold text-lg mb-2 text-gray-800">{t('main_tag')}</h3>
      ...
      <div>
        <h3 className="font-bold text-lg mb-2 text-gray-800">{t('tags')}</h3>
        <div className="flex flex-wrap gap-2">
          {tags.map(tag => (
      ...
      <div>
        <h3 className="font-bold text-lg mb-2 text-gray-800">{t('sizes')}</h3>
        <div className="flex flex-wrap gap-2">
          {sizes.map(size => (
